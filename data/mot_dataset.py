...
class MOTDataset(Dataset):
    ...
    def get_dataset_structure(self, dataset: str, split: str):
        ...
        ##VAS_MOT
        elif dataset == "VAS_MOT":
            split_dir = os.path.join(dataset_dir, split)
            label_dir = os.path.join(dataset_dir, 'labels_with_ids', split)
            seq_names = os.listdir(split_dir)
            structure["seqs"] = {
                seq: {
                    "images_dir": os.path.join(split_dir, seq, "img"),
                    "gt_path": os.path.join(label_dir, seq, "format_gt.txt"),
                    "images_name": os.listdir(os.path.join(split_dir, seq, "img")),
                    "max_frame": max([int(_[:-4]) for _ in os.listdir(os.path.join(split_dir, seq, "img"))])
                }
                for seq in seq_names
            }
    ...
    def get_dataset_infos(self):
        ...
        for dataset in self.datasets:
            seqs = dataset["seqs"]
            #print(seqs)
            #{'vehicle-001': {'images_dir': 'data/datasets4MOTIP/HS-T/train/vehicle-001/img', 
            # 'gt_path': 'data/datasets4MOTIP/HS-T/labels_with_ids/train/vehicle-001/format_gt.txt', 
            # 'images_name': ['000015.jpg', '000017.jpg', '000010.jpg', '000009.jpg', '000001.jpg', '000008.jpg', '000012.jpg', '000016.jpg', '000005.jpg',
            #  '000013.jpg', '000003.jpg', '000004.jpg', '000002.jpg', '000000.jpg', '000014.jpg', '000007.jpg', '000011.jpg', '000006.jpg'], 'max_frame': 256},
                    ...
                    with open(gt_path, "r") as gt_file:
                        for line in gt_file:
                            ...
                            if dataset_name == "DanceTrack" or dataset_name == "SportsMOT":
                                ...
                                label = 0
                            elif dataset_name == "VAS_MOT" :
                                f, i, x, y, w, h, l = line.split(" ")
                                v = 1
